...
@section('content')
    ...
    <tr>
      ...
      <td>
        <a href="/{{ $contact->id }}"><img src="/../images/about.png" style="width:16px; height:16px;" title="About" /></span></a>
      </td>
      <td>
        <a href="/{{ $contact->id }}/edit"><img src="/../images/edit.png" style="width:16px; height:16px;" title="Edit" /></a>
      </td>
      <td>
        <a href="/favorite" class="favorite" data-contact_id="{{ $contact->id }}" data-favorite="{{ $contact->favorite }}"><img src="/../images/favorite_{{ $contact->favorite }}.png" style="width:16px; height:16px;" /></a>
      </td>
      <td>
